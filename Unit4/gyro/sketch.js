...
function setup() {
  ...
  cursed = loadImage("assets/cursed.jpg") ;
  wat = loadImage("assets/wat.png")
  imageMode(CENTER);
  rectMode(CENTER);
  noStroke();
}
...
function draw() {
  ...
  textSize(40);
  textAlign(CENTER);
  text("What is happening", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    ...
    image(cursed, this.pos.x - 50, this.pos.y, 50, 50);
